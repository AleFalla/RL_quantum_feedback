...
cases={
    ...
    '16_h_0.3':{'wm':1,'k':16,'y':2e-7,'eta':1,'g':0.3,'detuning':-1,'ne':3.5e5,'na':0,'phi':-0.48*math.pi},
    '16_r_0.3':{'wm':1,'k':16,'y':1.14e-4,'eta':1,'g':0.3,'detuning':-1,'ne':2,'na':0,'phi':0.52*math.pi},
    '0.5_h_0.9':{'wm':1,'k':0.5,'y':2e-7,'eta':1,'g':0.9,'detuning':-1,'ne':3.5e5,'na':0,'phi':-0.16*math.pi},#from here g=0.9
